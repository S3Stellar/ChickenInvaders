...
public class Invader {
    ...
    public Invader(Context context, int column, int screenX, int screenY) {
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.chicken1);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.chicken2);
